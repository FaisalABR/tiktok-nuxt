          ...
          <div class="relative">
            ...
            >
              <NuxtLink
                ...
                class="flex items-center justify-start px-2 py-3 hover:bg-gray-300 cursor-pointer"
              >
                <Icon name="ph:user" size="20" />
                <span class="pl-2 font-semibold text-sm">Profile</span>
              </NuxtLink>
              <div
                class="flex items-center justify-start px-1.5 py-3 hover:bg-gray-300 border-t cursor-pointer"
              >
