    ...
    >
      <div class="flex w-[calc(100vw-230px)]">
        ...
        <div class="ml-5 w-full">
          <div class="text-[30px] font-bold truncate">Username</div>
          ...
          <button
            v-else
            class="flex item-center rounded-md py-1.5 px-8 mt-3 text-[15px] font-semibold border bg-[#f02c56] text-white"
          >
            <div>Follow</div>
          </button>
        </div>
