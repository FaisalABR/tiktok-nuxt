<template>
  ...
  >
    <div class="lg:w-[calc(100%-540px)] h-full relative">
      <NuxtLink
        class="absolute z-50 m-5 rounded-full bg-gray-700 p-1.5 hover:bg-gray-800"
      >
        <Icon
      ...
      <div class="flex items-center justify-between px-8">
        <div class="flex items-center">
          ...
          <div class="ml-3 pt-0.5">
            <div class="text-[17px] font-semibold">Username</div>
          ...
          <div class="flex items-center relative w-full">
            ...
            <div class="ml-14 pt-0.5 w-full">
              ...
              <div class="text-[15px] font-light">
                ...
                Quisquam, possimus adipisci consequuntur provident culpa hic
                facere veritatis earum impedit vitae?
              </div>
            </div>
          </div>
        </div>
